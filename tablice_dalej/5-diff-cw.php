...
printLn(); printLn('---uzycie zewnetrznej funckji porownujacej klucze tablic');
$a = array('1'=>'a', '2'=>'b', '3'=>'c');
$b = array('3'=>'d', '4'=>'e', '5'=>'f');
printLn('tablice wej:'); printLn($a); printLn($b);
$compare = function($v1, $v2) {
	if($v1 < $v2) return -1;
	if($v1 > $v2) return 1;
	return 0;
};
printLn('tablice wynikowa:'); printLn(array_diff_ukey($a, $b, $compare));